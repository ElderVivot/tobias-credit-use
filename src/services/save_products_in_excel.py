...
class SaveProductsInExcel():
    ...
    def __writeReader(self):
        ...
        self._sheet.write(0, 14, "Regra aplicada pra este NCM", self._cell_format_header)
    ...
    def __writeRows(self, product: Dict[str, str]) -> None:
        ...
        numeroItemProduto = treatsFieldAsTextInDictOrArray(product, ['prod_numero_item'])
        ...
        self._sheet.write(self._row, 18, valorUnitario, self._cell_format_money)
        self._sheet.write(self._row, 19, valorProduto, self._cell_format_money)
        self._sheet.write(self._row, 20, valorDesconto, self._cell_format_money)
