...
class SaveProductsInExcel():
    ...
    def __writeRows(self, product: Dict[str, str]) -> None:
        ...
        self._sheet.write(self._row, 3, dataEmissaoNF)
        ...
        self._sheet.write(self._row, 17, valorUnitario)
        self._sheet.write(self._row, 18, valorProduto)
        self._sheet.write(self._row, 19, valorDesconto)
        self._sheet.write(self._row, 20, valorFrete)
        self._sheet.write(self._row, 21, valorOutros)
        self._sheet.write(self._row, 22, valorVSeg)
        self._sheet.write(self._row, 23, valorTotal)
