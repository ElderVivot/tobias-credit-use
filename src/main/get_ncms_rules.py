...
class GetNcms():
    def __init__(self, saveResultProcessInFile=True, returnOnlyValueNcm=False):
    ...
    def process(self, dataJson: dict) -> dict:
    ...
    def saveResultProcess(self, listData: List[dict]):
